...
const Page = (props) => {
    ...
    return(
        <Container>
            <HeaderText>Opções de treino pré-criados com base no seu nivel.</HeaderText>
...
Page.navigationOptions = ({navigation}) =>{
    ...
    return{
        headerShown:true,
        title:'',
        headerRight:()=><NextButton onPress={nextAction}><NextButtonText>{btnNext}</NextButtonText></NextButton>,
